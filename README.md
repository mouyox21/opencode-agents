...
| [frontend-specialist](./01-core-development/frontend-specialist.md) | USE PROACTIVELY for creating UI components with shadcn/ui, implementing responsive designs with Tailwind CSS, ensuring WCAG accessibility compliance, optimizing frontend performance, and building modern React applications. MUST BE USED for component architecture, design system implementation, user interface design, and frontend performance optimization. |
...
| [migration-specialist](./01-core-development/migration-specialist.md) | Invoke for handling schema and data migrations, ensuring safe migrations, and maintaining data integrity |
...
| [config-expert](./03-infrastructure/config-expert.md) | Invoke for managing environment configurations, securing sensitive data, and ensuring consistency across environments |
...
| [docker-specialist](./03-infrastructure/docker-specialist.md) | Invoke for optimizing containerization, creating efficient Docker images, and implementing orchestration |
...
| [iac-expert](./03-infrastructure/iac-expert.md) | Invoke for managing cloud resources as code, ensuring scalability, and implementing disaster recovery |
...
| [monitoring-architect](./03-infrastructure/monitoring-architect.md) | Invoke for ensuring system observability, creating actionable alerts, building dashboards, and enabling quick issue resolution |
...
| [integration-test-builder](./04-quality-security/integration-test-builder.md) | Invoke for building API tests, database tests, and service interaction tests |
...
| [performance-profiler](./04-quality-security/performance-profiler.md) | Invoke for identifying performance bottlenecks, optimizing resource usage, and ensuring SLA compliance |
...
| [schema-validator](./04-quality-security/schema-validator.md) | USE PROACTIVELY for implementing runtime type checking, input validation, API contract enforcement, schema-driven form validation, and type-safe data boundaries. MUST BE USED for validation strategy design, schema library creation, API request/response validation, form validation integration, and TypeScript type generation from schemas. |
...
| [unit-test-generator](./04-quality-security/unit-test-generator.md) | Invoke for creating comprehensive unit tests with edge cases, mocks, and high code coverage |
...
| [code-commentator](./06-developer-experience/code-commentator.md) | Invoke for adding helpful inline documentation, explaining complex logic, and documenting APIs with proper comments |
...
| [refactoring-expert](./06-developer-experience/refactoring-expert.md) | Invoke for reducing technical debt, improving code maintainability, implementing design patterns, and simplifying complex code |
...
| [release-compiler](./08-business-product/release-compiler.md) | Invoke for creating release notes, documenting breaking changes, providing migration guides, and compiling changelogs |
...
| [tech-writer](./08-business-product/tech-writer.md) | Invoke for creating comprehensive documentation, API docs, onboarding guides, and technical architecture documentation |
...
| [project-orchestrator](./09-meta-orchestration/project-orchestrator.md) | USE PROACTIVELY for breaking down complex project specifications, orchestrating multi-agent workflows, and managing end-to-end feature delivery. MUST BE USED when receiving project briefs or specifications that require coordination across multiple specialized domains (frontend, backend, testing, security, etc.) |
